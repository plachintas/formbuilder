...
(function() {
  ...
  EditFieldView = (function(_super) {
    ...
    EditFieldView.prototype.triggerUpdated = function() {
      return this.model.trigger('change');
    };
  ...
  BuilderView = (function(_super) {
    ...
    BuilderView.prototype.getFormData = function() {
      this.collection.sort();
  ...
  Formbuilder = (function() {
    ...
    Formbuilder.doNotRegisterField = function() {};
    ...
    Formbuilder.prototype.getFormData = function() {
      return this.mainView.getFormData();
    };

    Formbuilder.prototype.getFormData_as_jsonSchema = function() {
...
(function() {
  Formbuilder.registerField('field_group', {
    ...
    edit: "",
    addButton: "<span class='symbol'><span class='fa fa-minus'></span></span> Field Group"
  });
...
this["Formbuilder"]["templates"]["edit/acl"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>ACL</div>\r\n\r\n<div class=\'option\' data-rv-each-option=\'model.' +
((__t = ( Formbuilder.options.mappings.ACL )) == null ? '' : __t) +
'\'>\r\n  <label data-rv-text="option:role"></label>\r\n\r\n  <div class="fb-acl-radios">\r\n    ';
 _.each(Formbuilder.options.ACL_OPTIONS, function(acl) { ;
__p += '\r\n      <label class="radio-inline" title="' +
((__t = ( acl.name )) == null ? '' : __t) +
'">\r\n        <input class="js-trigger-updated" type="radio" data-rv-checked="option:rights" data-rv-name="option:role" value="' +
((__t = ( acl.id )) == null ? '' : __t) +
'">\r\n        ' +
((__t = ( acl.id )) == null ? '' : __t) +
'\r\n      </label>\r\n    ';
...
((__t = ( Formbuilder.templates['edit/base_header']() )) == null ? '' : __t) +
'\r\n' +
((__t = ( Formbuilder.templates['edit/common']({ noRequired: true }) )) == null ? '' : __t) +
'\r\n' +
((__t = ( Formbuilder.fields[rf.get(Formbuilder.options.mappings.FIELD_TYPE)].edit({rf: rf}) )) == null ? '' : __t) +
'\r\n';
...
'\r\n  </div>\r\n\r\n  ';
 if (typeof noRequired === 'undefined'){ ;
__p += '\r\n    <div class=\'fb-common-checkboxes\'>\r\n      ' +
((__t = ( Formbuilder.templates['edit/checkboxes']() )) == null ? '' : __t) +
'\r\n    </div>\r\n  ';
 } ;
__p += '\r\n\r\n  ';
 if (typeof noAcl === 'undefined'){ ;
__p += '\r\n    <!-- <div class="fb-acl">\r\n      ' +
((__t = ( Formbuilder.templates['edit/acl']() )) == null ? '' : __t) +
'\r\n    </div> -->\r\n  ';
 } ;
...
this["Formbuilder"]["templates"]["edit/error_message"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>Error Message</div>\r\n<input style="width: 100%;" type="text" data-rv-input="model.' +
((__t = ( Formbuilder.options.mappings.ERROR_MESSAGE )) == null ? '' : __t) +
'" />\r\n';
...
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'" title="Remove Option"><i class=\'fa fa-minus-circle\'></i></a> -->\r\n  <button type="button" class="js-remove-option close" title="Remove Option">\r\n    <span aria-hidden="true">×</span>\r\n  </button>\r\n</div>\r\n\r\n';
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>Pattern</div>\r\n<input style="width: 100%;" type="text" data-rv-input="model.' +
...
((__t = ( Formbuilder.options.BUTTON_CLASS_SAVE )) == null ? '' : __t) +
'\'></button>\r\n</div>';
...
this["Formbuilder"]["templates"]["view/acl_view"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {
__p += '<ul class="acl-view list-inline">\r\n  ';
 options = rf.get(Formbuilder.options.mappings.ACL) ;
__p += '\r\n\r\n  <!-- TODO: -->\r\n  ';
 titles = {}; ;
__p += '\r\n  ';
 _.each(Formbuilder.options.ACL_OPTIONS, function(acl) { titles[acl.id] = acl.name; }); ;
__p += '\r\n\r\n  ';
 _.each(options, function(option) {
    ;
__p += '<li title="' +
((__t = ( option.role )) == null ? '' : __t) +
': \'' +
((__t = ( titles[option.rights] )) == null ? '' : __t) +
'\'">\r\n      ' +
((__t = ( option.rights )) == null ? '' : __t) +
'\r\n    </li>';
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'subtemplate-wrapper fb-group-item\'>\r\n  <div class=\'cover\'></div>\r\n  ' +
((__t = ( Formbuilder.fields[rf.get(Formbuilder.options.mappings.FIELD_TYPE)].view({rf: rf}) )) == null ? '' : __t) +
'\r\n\r\n  ' +
((__t = ( Formbuilder.templates['view/duplicate_remove']({rf: rf}) )) == null ? '' : __t) +
'\r\n</div>\r\n';
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'actions-wrapper\'>\r\n  <button type="button" class="js-duplicate close" title="Duplicate Field">\r\n    <span aria-hidden="true">+</span>\r\n  </button>\r\n\r\n  <button type="button" class="js-clear close" title="Remove Field">\r\n    <span aria-hidden="true">×</span>\r\n  </button>\r\n</div>';
